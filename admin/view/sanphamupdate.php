<?php
    ...
    $html_danhmuclist = showdanhmuc_admin_update($danhmuclist, $iddm);
?>
...
<div class="main-content">
                ...
                <form class="addPro" action="index.php?pg=updateproduct" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="soluong" value="<?=($soluong!="")?$soluong:"";?>" id="soluong" placeholder="Nhập số lượng">
                    </div>

                    <div class="form-group">
                        <label>Mô tả ngắn</label>
                        <textarea class="form-control" name="description" rows="3"
                            placeholder="Nhập 1 đoạn mô tả ngắn về sản phẩm" style="height: 78px;"><?=($mota!="")?$mota:"";?></textarea>
                    </div>
